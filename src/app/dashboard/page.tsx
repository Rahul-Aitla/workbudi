...
import { RobinSidebar } from "@/components/robin/robin-sidebar";
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-1">
        ...
        {/* Robin Sidebar */}
        <aside className="hidden lg:flex w-96 shrink-0 sticky top-14 h-[calc(100vh-3.5rem)] border-l">
          <RobinSidebar
            userName={user.user_metadata?.full_name?.split(" ")[0] ?? user.email?.split("@")[0] ?? "there"}
